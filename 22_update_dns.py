...
CONTENT = sys.argv[4] if len(sys.argv) > 4 else "8.8.8.8"


def update_dns(domain_id: int, name: str, record_type: str, content: str) -> dict:
    response = client.put(
...
if __name__ == "__main__":
    print(json.dumps(update_dns(DOMAIN_ID, NAME, RECORD_TYPE, CONTENT), indent=2))
